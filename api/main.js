...
mongoose.connect('mongodb://127.0.0.1:27017/meanpro')
var adminSchema=require('./database/admin');
...
app.post("/signup",function(req,res)
{
    ...
    html: '<a href="http://localhost:8045/active/"+to>Click Here</a>' // html body
};
...
app.post("/chpass",function(req,res)
{
    ...
    //alert(np);
    //console.log(np);
    adminSchema.find({id:uid}).exec(function(err,data)
    {
        if(op===data[0].pass)
        {
...
app.post("/login",function(req,res)
{
    id1=req.body.id;
    pass1=req.body.pass;
    adminSchema.find({id:id1,pass:pass1},function(err,data)
    {
   if (err) {
